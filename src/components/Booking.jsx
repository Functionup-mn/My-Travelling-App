...
const Booking = () => {
  return (
    <div
      className="max-w-[1140px] md:h-48 gap-5 mt-5 mx-5 flex flex-col justify-start h-[70vh] md:flex-row md:justify-center"
      id="details"
    >
      ...
      <div className="flex flex-col lg:w-[250px] w-full ">
        <label className=" text-lg font-semibold">Check-In</label>
        <input
          className="p-[7px] border rounded-md outline-none"
          type="date"
          name=""
          id=""
        />
